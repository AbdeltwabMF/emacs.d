...
- [[#applications][Applications]]
  - [[#emacs-application-framework][Emacs Application Framework]]
    - [[#browser][Browser]]
      - [[#default-blank-page][Default “Blank” Page]]
      - [[#default-search-engine][Default Search Engine]]
      - [[#disable-saving-browsing-history][Disable Saving Browsing History]]
      - [[#customize-download-path][Customize Download Path]]
      - [[#enable-adblocker][Enable Adblocker]]
